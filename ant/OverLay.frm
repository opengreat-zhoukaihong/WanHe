...
Sub MakeThematic(SelectCell As String)
    ...
    End If     'win95
    If Legend_Tog = 0 Then
       MyMsg = " Title " + Chr(34) + "确定小区覆盖 " + tblname + " NeighborLay" + Chr(34) + " Font (""宋体"",0,9,0) Subtitle" + Chr(34) + USERNAME + Chr(34) + " Font (""宋体"",0,9,0) ascending on ranges Font (""宋体"",0,9,0) ""其余全部"" display off ,""0 至 17 (-110至-93dBm)"" display on ,""17 至 27 (-93至-83dBm)"" display on ,""27 至 63 (-83至-47dBm)"" display on ,""63 以上 (大于-47dBm)"" display on"
    Else
       MyMsg = " Title " + Chr(34) + "确定小区覆盖 " + tblname + " NeighborLay" + Chr(34) + " Font (""宋体"",0,9,0) Subtitle" + Chr(34) + USERNAME + Chr(34) + " Font (""宋体"",0,9,0) ascending on ranges Font (""宋体"",0,9,0) ""其余全部"" display off ,""0 至 5 (-110至-105dBm)"" display on ,""5 至 10 (-105至-100dBm)"" display on ,""10 至 15 (-100至-95dBm)"" display on ,""15 至 20 (-95至-90dBm)"" display on ,""20 至 25 (-90至-85dBm)"" display on ,""25 至 30 (-85至-80dBm)"" display on ,""30 至 35 (-80至-75dBm)"" display on ,""35 至 40 (-75至-70dBm)"" display on ,""40 至 45 (-70至-65dBm)"" display on ,""45 至 50 (-65至-60dBm)"" display on ,""50 至 63 (-60至-47dBm)"" display on ,""63 以上 (大于-47dBm)"" display on"
    End If
    mapinfo.do "set legend window FrontWindow() Layer prev display on shades off symbols on lines off count on " & MyMsg
